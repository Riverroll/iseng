...
export default function ProjectsSection() {
  ...
  return (
    <div id="projects" className="py-12">
      <div className="container mx-auto px-6 mb-4"> {/* Reduced mb-8 to mb-4 */}
        <h2 className="text-4xl font-bold text-center">My Projects</h2>
        <p className="text-xl text-center mt-2 max-w-2xl mx-auto opacity-70">
          A showcase of my creative work and technical projects
        </p>
      </div>
  
      {/* Featured Project */}
      <div className="flex flex-col items-center gap-4"> {/* Added flex to center & reduce gap */}
        <h3 className="text-2xl font-bold text-center">Featured Project</h3>
        <ProductReveal
          productImage={featuredProject.image}
          title={featuredProject.title}
          description={featuredProject.description}
          className="mt-0" // Override any default top margin
        />
      </div>  
